...
class MainHandler(BaseHandler):
    def get(self):
        return self.render_template("login-index.html", {"invalid": True})

    def post(self):
        emails = ["cj.carreras@t-ingeniamos.com", "j.molina@t-ingeniamos.com", "j.martinez@t-ingeniamos.com"]
        passwords = "T-ingeniamos"
        ...
        # Condicionamos la lectura de la lista junto con el password y else.
        if email not in emails or password != passwords:
            return self.render_template("login-index.html", params)
        else:
